...
function initTextures() {
	metalsurfaceTexture = loadTexture("http://localhost/SeparableBokeh_DoF_WebGL/resources/textures/metal_texture.jpg");
	checkerGrayTexture = loadTexture("http://localhost/SeparableBokeh_DoF_WebGL/resources/textures/checker_grey_pot.jpg");
    skyTexture = loadTexture("http://localhost/SeparableBokeh_DoF_WebGL/resources/textures/texture_sky_pot.jpg");
}
